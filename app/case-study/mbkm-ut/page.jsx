...
.case-study-wrapper .user-card.student .user-badge {
...
` }} />
  ...
  <div className="page" style={{ paddingBottom: "0" }}>
    <div className="hero-inner">
      ...
      <p className="hero-sub">Universitas Terbuka · Unified Student Internship & Attendance Experience</p>
      <div className="hero-tags">
        <span className="tag">Figma</span>
        <span className="tag">Web Design</span>
        <span className="tag">Mobile App Design</span>
        <span className="tag">Education</span>
        <span className="tag">Shared Design System</span>
        <span className="tag">UX Optimization</span>
      </div>
      <div className="hero-meta">
        <div className="hero-meta-item"><div className="hero-meta-label">Client</div><div className="hero-meta-val">Universitas Terbuka</div></div>
...
<div className="page">
  ...
  <section id="context">
    <div className="section-label">Context & Challenge</div>
  ...
  <section id="users">
    <div className="section-label">User Demographics</div>
    ...
    <div className="user-grid">
      <div className="user-card student">
        <span className="user-badge">Students</span>
        <h3>Goals & Needs</h3>
        <ul>
      ...
      <div className="user-card admin">
        <span className="user-badge">Program Chairs (Kaprodi)</span>
        <h3>Goals & Needs</h3>
        <ul>
  ...
  <section id="process">
    <div className="section-label">Design Process</div>
  ...
  <section id="screens">
    <div className="section-label">Visual Design & UX Highlights</div>
    <h2>Focusing on <strong>Efficiency and Clarity</strong></h2>
    
    <div className="screen-block">
      <div className="screen-label">Student Portal: Single Dashboard Flow</div>
      <img className="screen-img" src="/projects/mbkm/MBKM Non PP.png" alt="Student portal MBKM dashboard" />
      <p className="screen-caption">The redesigned dashboard offers students a single point of entry to discover programs, track registration steps, and view logbooks.</p>
    </div>

    <div className="screen-2col">
      <div>
        <div className="screen-label">Frictionless Authentication</div>
        <img className="screen-img" src="/projects/mbkm/Login.png" alt="Login screen" />
        <p className="screen-caption">A clean, high-contrast login screen tailored for quick identification and responsive mobile rendering.</p>
      </div>
      <div>
        <div className="screen-label">Inbound Program Registration</div>
        <img className="screen-img" src="/projects/mbkm/Inbound PP UT.png" alt="Inbound registration flow" />
        <p className="screen-caption">The multi-step inbound program registration provides clear indicators showing which documents are complete.</p>
      </div>
    </div>

    <div className="screen-block">
      <div className="screen-label">Program Chairs: Batch Verification</div>
      <img className="screen-img" src="/projects/mbkm/Kaprodi.png" alt="Kaprodi dashboard screen" />
      <p className="screen-caption">An optimized dashboard layout for Program Chairs (Kaprodi) featuring dense, filterable tables to handle student validations quickly.</p>
    </div>

    <div className="screen-2col">
      <div>
        <div className="screen-label">Student Exchange Portal</div>
        <img className="screen-img" src="/projects/mbkm/Pertukaran Pelajar.png" alt="Pertukaran Pelajar registration" />
        <p className="screen-caption">Step-by-step validation guide explaining courses, credits, and requirements for student exchanges.</p>
      </div>
      <div>
        <div className="screen-label">Summer Course Selection</div>
        <img className="screen-img" src="/projects/mbkm/Summer Course.png" alt="Summer course selection interface" />
        <p className="screen-caption">A cards-based visual directory enabling students to scan and select available summer courses.</p>
      </div>
    </div>
  </section>
  ...
  <section id="decisions">
    <div className="section-label">Key Design Decisions</div>
  ...
  <section id="results">
    <div className="section-label">Results & Impact</div>
    <h2>Measurable <strong>Improvements</strong></h2>
    <div className="results-grid">
      <div className="result-card">
        <div className="result-num">100%</div>
        <div className="result-label">Registration & Attendance Unified</div>
      </div>
      <div className="result-card">
        <div className="result-num">4.8★</div>
        <div className="result-label">Student Usability Rating</div>
      </div>
      <div className="result-card">
        <div className="result-num">-60%</div>
        <div className="result-label">Reduction in Administrative Delay</div>
      </div>
    </div>
    <div className="quote-block">
      ...
      <div className="quote-attr">UNIVERSITAS TERBUKA ADMIN TEAM</div>
    </div>
  </section>

  
  <section id="reflection">
    <div className="section-label">Key Reflection</div>
...
<div className="footer">
  <div>
    ...
    <div className="footer-role">UI/UX Designer</div>
  </div>
  <div className="footer-links">
    <a href="/" className="footer-link">Portfolio</a>
    <a href="https://www.linkedin.com/in/arrozy-adi-falaqi-6a25ba14a" target="_blank" rel="noreferrer" className="footer-link">LinkedIn</a>
    <a href="https://www.behance.net/arrozyadifalaqi" target="_blank" rel="noreferrer" className="footer-link">Behance</a>
  </div>
</div>
    </div>
  );
