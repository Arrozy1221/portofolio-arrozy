        ...
        <section>
          <div className="cs-screens-section">
            ...
            <div className="cs-screen-block">
              ...
              <img className="cs-screen-img" src="/projects/hidrolika/Web Hidrolika.png" alt="Web Hidrolika Main" />
            ...
            <div className="cs-screen-2col">
              <div>
                ...
                <img className="cs-screen-img" src="/projects/hidrolika/Login.png" alt="Login Portal" />
                <p className="cs-screen-caption">{cs.screens.s1.caption}</p>
              </div>
              <div>
                <div className="cs-screen-label">{cs.screens.s2.label}</div>
                <img className="cs-screen-img" src="/projects/hidrolika/Login - Web Hidrolika.png" alt="Login - Web Hidrolika" />
