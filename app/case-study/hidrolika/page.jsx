...
export default function Page() {
  ...
  const cs = t.caseStudies.hidrolika;

  const keyScreens = [
    { key: "s1", img: "/projects/hidrolika/Login.png", alt: "Login Portal" },
    { key: "s2", img: "/projects/hidrolika/Login - Web Hidrolika.png", alt: "Login - Web Hidrolika" },
    { key: "s3", img: "/projects/hidrolika/Web Hidrolika.png", alt: "Web Hidrolika Main" }
  ];

  return (
    <div className="cs-case-study-wrapper" style={{ '--primary': '#0284C7', '--blue': '#0284C7', '--blue-dark': '#0C4A6E', '--teal': '#0EA5E9', '--blue-light': '#F0F9FF', '--dark': '#0B0F19', '--dark2': '#0F172A', '--mid': '#334155', '--muted': '#64748B', '--border': '#E2E8F0', '--surface': '#F8FAFC', '--white': '#FFFFFF', '--grad': 'linear-gradient(135deg, #0284C7 0%, #0EA5E9 100%)' }}>
      ...
      <div className="cs-hero">
        ...
        <div className="cs-hero-mockup">
          <div className="cs-page" style={{ paddingBottom: "0" }}>
            <img src="/projects/barata-hidrolika.png" alt="Web Hidrolika Telemetry" />
          </div>
        </div>
      </div>
      ...
      <div className="cs-page">
        ...
        <section>
          <div className="cs-screens-section">
            ...
            <div className="cs-screen-block">
              ...
              <ImageZoom className="cs-screen-img" src="/projects/hidrolika/Web Hidrolika.png" alt="Web Hidrolika Main" />
            ...
            <div className="cs-screen-2col">
              <div>
                ...
                <ImageZoom className="cs-screen-img" src="/projects/hidrolika/Login.png" alt="Login Portal" />
                <p className="cs-screen-caption">{cs.screens.s1.caption}</p>
              </div>
              <div>
                <div className="cs-screen-label">{cs.screens.s2.label}</div>
                <ImageZoom className="cs-screen-img" src="/projects/hidrolika/Login - Web Hidrolika.png" alt="Login - Web Hidrolika" />
