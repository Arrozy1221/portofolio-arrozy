...
.case-study-wrapper .problem-card h3 {
 font-size:14px; margin-bottom:8px; }
.case-study-wrapper .problem-card p {
...
.case-study-wrapper .ba-grid {

      grid-template-columns: 1fr;
      gap: 20px;
    }
.case-study-wrapper .problem-grid {
...
.case-study-wrapper .all-screens-wrap {
...
` }} />
  ...
  <div className="page" style={{ paddingBottom: "0" }}>
    <div className="hero-inner">
      ...
      <p className="hero-sub">Kemendikbud · Sistem Monitoring Tindak Lanjut Hasil Pemeriksaan</p>
      <div className="hero-tags">
        <span className="tag">Figma</span>
        <span className="tag">Dashboard Redesign</span>
        <span className="tag">Admin UI</span>
      ...
      <div className="hero-meta">
        <div className="hero-meta-item"><div className="hero-meta-label">Client</div><div className="hero-meta-val">Kemendikbud</div></div>
        <div className="hero-meta-item"><div className="hero-meta-label">Role</div><div className="hero-meta-val">Sole UI/UX Designer</div></div>
...
<section>
  ...
  <div className="process-steps">
    <div className="process-step">
      ...
      <div className="step-content"><h3>Brief analysis</h3><p>Mapped all pain points from the client brief to specific UI/UX failure patterns — poor IA, no visual hierarchy, and redundant task flows — before touching any design.</p></div>
    </div>
    <div className="process-step">
      <div className="step-num">02</div>
      <div className="step-content"><h3>Information architecture restructuring</h3><p>Reorganized the navigation taxonomy so items group by user intent — Dashboard, Tindak Lanjut, Manajemen LHP, Pelaporan, Pengaturan — rather than internal system logic.</p></div>
    </div>
    <div className="process-step">
      <div className="step-num">03</div>
      <div className="step-content"><h3>Component design in Figma</h3><p>Built a consistent component set: filterable data tables, color-coded status badges (S, BTL, P, BS), action toolbars, summary cards, and filter forms — all reusable across every section.</p></div>
    </div>
    <div className="process-step">
      <div className="step-num">04</div>
      <div className="step-content"><h3>High-fidelity UI + dev handoff</h3><p>Delivered complete redesign with handoff-ready specs and a component library for the development team to reference during implementation.</p></div>
    </div>
  </div>
</section>
...
<section>
  ...
  <div className="screen-block">
    ...
    <img className="screen-img" src="/images/case-study/simontila/img_4.png" alt="Login" />
    <p className="screen-caption">Clean split-screen login with the Simontila brand. Blue gradient left panel creates authority and trust, white right panel keeps the form focused and distraction-free.</p>
  </div>

  <div className="screen-2col">
    <div>
      <div className="screen-label">Manajemen LHP</div>
      <img className="screen-img" src="/images/case-study/simontila/img_5.png" alt="Manajemen LHP" />
      <p className="screen-caption">Inspection management with a structured filter form above a data table — admins can filter by institution, period, and inspector, then act on results in one view.</p>
    </div>
    <div>
      <div className="screen-label">Pelaporan — Rekap per Provinsi</div>
      <img className="screen-img" src="/images/case-study/simontila/img_6.png" alt="Pelaporan" />
      <p className="screen-caption">Reporting module with multi-parameter filtering. Consistent layout across all data views reduces cognitive load for admins who switch between sections frequently.</p>
    </div>
  </div>

  <div className="screen-block">
    <div className="screen-label">Tindak Lanjut — Follow-up tracking</div>
    <img className="screen-img" src="/images/case-study/simontila/img_7.png" alt="Tindak Lanjut" />
    <p className="screen-caption">Follow-up tracking page with a summary header showing totals by status (S, BTL, P, BS) and value — giving admins an instant overview before working through individual records below.</p>
  </div>

  <div className="screen-2col">
    <div>
      <div className="screen-label">Data Temuan — Full table view</div>
      <img className="screen-img" src="/images/case-study/simontila/img_8.png" alt="Data Temuan" />
      <p className="screen-caption">Dense audit finding data made scannable with structured rows, color-coded status badges, and inline "Tindak Lanjut" action buttons — eliminating separate detail page navigation for routine tasks.</p>
    </div>
    <div>
      <div className="screen-label">Transaction table</div>
      <img className="screen-img" src="/images/case-study/simontila/img_9.png" alt="Container" />
      <p className="screen-caption">Latest transaction component with clear columns, status badges (Confirm, Pending, Cancel), and row-level icon actions for view, edit, and delete — all in one scannable view.</p>
    </div>
  </div>
</section>
...
<section>
  ...
  <div className="results-grid">
    <div className="result-card"><div className="result-num">30%</div><div className="result-label">Improvement in data management clarity — stakeholder evaluation post-delivery</div></div>
    <div className="result-card"><div className="result-num">2 clicks</div><div className="result-label">To complete core admin tasks — down from 4–5 navigational steps</div></div>
    <div className="result-card"><div className="result-num">1×</div><div className="result-label">Component library delivered for faster, consistent developer handoff</div></div>
  </div>
  <div className="quote-block">
    ...
    <div className="quote-attr">— Stakeholder feedback post-delivery, SIMONTILA · 2024</div>
  </div>
</section>
...
<div className="all-screens-wrap">
  <div className="page">
