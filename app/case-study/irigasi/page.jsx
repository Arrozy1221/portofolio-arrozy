...
export default function Page() {
  ...
  const cs = t.caseStudies.irigasi;

  const keyScreens = [
    { key: "s1", img: "/projects/irigasi/Dashboard.png", alt: "Dashboard Utama" },
    { key: "s2", img: "/projects/irigasi/Detail Berita.png", alt: "Detail Berita & Informasi" },
    { key: "s3", img: "/projects/irigasi/Web Irigasi v1.png", alt: "Web Irigasi Portal Mockup" }
  ];

  return (
    <div className="cs-case-study-wrapper" style={{ '--primary': '#059669', '--blue': '#059669', '--blue-dark': '#064E3B', '--teal': '#10B981', '--blue-light': '#ECFDF5', '--dark': '#060B12', '--dark2': '#0F172A', '--mid': '#334155', '--muted': '#64748B', '--border': '#E2E8F0', '--surface': '#F8FAFC', '--white': '#FFFFFF', '--grad': 'linear-gradient(135deg, #059669 0%, #10B981 100%)' }}>
      ...
      <div className="cs-hero">
        ...
        <div className="cs-hero-mockup">
          <div className="cs-page" style={{ paddingBottom: "0" }}>
            <img src="/projects/barata-irigasi.png" alt="Web Irigasi Dashboard" />
          </div>
        </div>
      </div>
