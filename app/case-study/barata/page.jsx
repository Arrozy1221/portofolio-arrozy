      ...
      <div className="cs-page">
        ...
        <section>
          ...
          <div className="cs-screen-block">
            ...
            <ImageZoom className="cs-screen-img" src="/projects/barata/Beranda.png" alt="Dashboard Utama" />
          ...
          <div className="cs-screen-2col">
            <div>
              ...
              <ImageZoom className="cs-screen-img" src="/projects/barata/Detail Data.png" alt="Detail Telemetri" />
              <p className="cs-screen-caption">{cs.screens.s2.caption}</p>
            </div>
            <div>
              <div className="cs-screen-label">{cs.screens.s3.label}</div>
              <ImageZoom className="cs-screen-img" src="/projects/barata/Infografis Bencana.png" alt="Infografis Bencana" />
          ...
          <div className="cs-screen-block">
            ...
            <ImageZoom className="cs-screen-img" src="/projects/barata/Peringatan Dini.png" alt="Sistem Peringatan Dini" />
          ...
          <div className="cs-screen-2col">
            <div>
              ...
              <ImageZoom className="cs-screen-img" src="/projects/barata/Layer Service.png" alt="Layanan Layer Peta" />
              <p className="cs-screen-caption">{cs.screens.s5.caption}</p>
            </div>
            <div>
              <div className="cs-screen-label">{cs.screens.s6.label}</div>
              <ImageZoom className="cs-screen-img" src="/projects/barata/Pop up Laporan.png" alt="Popup Laporan" />
